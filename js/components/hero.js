      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        ...
        <div class="lg:col-span-5 relative">
          <div class="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white aspect-[4/5] bg-sand">
            <img src="assets/images/ro-halfhide-portrait.jpg" alt="Ro Halfhide - Reau" class="w-full h-full object-cover object-center transform hover:scale-105 transition-transform duration-700">
